...
\* ================================== */
				...
				<style>
								...
								@media only screen and (max-width: 768px) {
												...
												.roundCoin {
																...
																border-bottom: 3px dotted steelblue;
																width: 75px;
																height: 75px;
												}
								}
				...
				<script type="text/javascript">
								...
								_smartsupp.key = '53feb26504f759bea8828fea7d23954b31db1d46';
																...
																<div class="uk-container" data-uk-navbar>
																				...
																				<div class="uk-navbar-right">
																								<div class="uk-navbar-item uk-visible@m in-optional-nav">
																												...
																												<a href="{{ route('register') }}" class="uk-button uk-button-primary uk-border-rounded">Sign
																																up<i class="fas fa-arrow-circle-right uk-margin-small-left"></i></a>
																								</div>
																				</div>
																</div>
												</nav>
																...
																<div class="uk-flex uk-flex-right uk-flex-middle right-content">
																				<span class="uk-margin-large-left">
																								<a href="{{ route('register') }}"
																												class="uk-button uk-button-secondary uk-button-large uk-border-rounded">Open your
																												account</a>
																				</span>
																</div>
												</div>
																								...
																								<div class="uk-child-width-1-2@s uk-child-width-1-4@m" data-uk-grid>
																												...
																												<div>
																																...
																																<ul class="uk-list uk-link-text">
																																				...
																																				<li><a href="{{route('contact')}}">Forgot Password?</a></li>
																																</ul>
																												</div>
																								</div>
																				</div>
				...
				<script>
								$('document').ready(function() {
												...
												setInterval(function() {
																var coins = ['es.png', 'eth.html', 'ap.html', 'dash.html', 'gg.html', 'xrp.html', 'es.html',
																				'ltc.html', 'ms.html', 'btc.png'
																];
