...
<div class="uk-section uk-section-secondary uk-preserve-color uk-background-contain uk-background-center in-equity-15" data-src="./wiwi/img/in-equity-decor-1.svg" data-uk-img>
    ...
    <p class="uk-text-lead uk-text-muted uk-margin-small-top"> Any Questions? We are here to answer you </p>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="uk-accordion-content uk-card uk-card-default uk-card-body uk-border-rounded" hidden="">
    <p>No you cannot have more than one account.</p>
    </div>
    </li>
    </ul>
    </div>
    ...
    <h2 class="uk-heading-small uk-margin-remove-bottom uk-text-primary">$<script>document.write(Math.ceil(Math.random() * 999))</script>+</h2>
    </div>
    <div>
    ...
    <div class="uk-flex uk-flex-left uk-flex-middle">
    <div class="uk-margin-right">
    <h2 class="uk-heading-small uk-margin-remove-bottom uk-text-primary"><script>document.write(Math.ceil(Math.random() * 99))</script>+</h2>
    </div>
    <div>
    <h3 class="uk-margin-small-bottom">Thousand</h3>
