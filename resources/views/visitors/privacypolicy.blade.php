...
<div class="uk-section uk-section-secondary uk-preserve-color uk-background-contain uk-background-center in-equity-15" data-src="./home/img/in-equity-decor-1.svg" data-uk-img>
  ...
  <h1 class="uk-margin-remove myWhite">Privacy Policy</h1>
  <p class="uk-text-lead uk-text-muted uk-margin-small-top">
  We are concerned about our user's privacy </p>
  </div>
  </div>
  </div>
  </div>
  ...
  <i class="fas fa-user fa-2x in-icon-wrap large primary-color uk-margin-right"></i>
  </div>
  ...
  <div class="uk-grid uk-grid-small" data-uk-grid="">
  <div class="uk-width-auto@m uk-first-column">
  <i class="fas fa-server fa-2x in-icon-wrap large primary-color uk-margin-right"></i>
  </div>
  <div class="uk-width-expand">
  <h3>Information Storage</h3>
  <div class="uk-text-large">Saving of information is only in our company or its equipment. Personal information is stored in
  ...
  <div class="uk-grid uk-grid-small" data-uk-grid="">
  <div class="uk-width-auto@m uk-first-column">
  <i class="fas fa-phone fa-2x in-icon-wrap large primary-color uk-margin-right"></i>
  </div>
  <div class="uk-width-expand">
  <h3>Contact Information</h3>
  <div class="uk-text-large">Wiiwiiprotrade is glad to receive your comments concerning this "Privacy Policy". In case you think
  that Wiiwiiprotrade does not follow the rules and violate this Statement, contact us
  at <a href='#'><span class="__cf_email__" data-cfemail="70191e161f30121904161f1c191f5e131f1d">[email&#160;protected]</span></a> We guarantee that we will take
