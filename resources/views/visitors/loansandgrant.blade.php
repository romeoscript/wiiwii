    ...
    <div class="row justify-content-between align-items-center gutter-vr-30px">
        ...
        <div class="col-lg-8">
            <div class="text-block">
                <h5 class="heading-xs dash">reef-fm</h5>
                ...
                <p class="lead">
                       ...
                       process! At reef-fm, we understand! Our investors want simple facts, honest answers
                       and competitive products.

DGS automatically offers loan services to investors with over $50,000 investment either in our normal reef-fm financial
...
identity of the investor are duly confirmed by reef-fm loan board.
...
GREAT INVESTING WITH reef-fm FAMILY
                                        </p>
            </div>
        </div><!-- .col -->
    </div><!-- .row -->
